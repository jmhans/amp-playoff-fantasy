  ...
  return (
    <main className="flex min-h-screen flex-col p-6 bg-white dark:bg-gray-900">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        {/* Fix Team Points Card */}
        <Link
          href="/admin/fix-points"
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-red-600">
                Fix Team Points
              </h2>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Reset premature spread scores
              </p>
            </div>
          </div>
        </Link>
